...
public class HttpAsyncGet<T> {
    private static final String TAG = "rosset " + HttpAsyncGet.class.getSimpleName();    //Pour affichage en cas d'erreur
        ...
        public String makeServiceCall(String reqUrl) {
            ...
            try {
                ...
                if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                    ...
                    System.out.println("On ecrit dans le fichier : "+rep);
                    writer.write(String.valueOf(rep));
                    writer.close();

                    System.out.println("On ecrit dans le fichier");
                    System.out.println("La réponse de l'API a été écrite dans le fichier items.json");
                } else {
                    Log.e(TAG, "Le stockage externe n'est pas disponible ou en lecture seule.");
                }
